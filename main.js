...
const amountInput = document.querySelector('.input-search')
const converterBtn = document.querySelector('.select_btn')
const money = document.querySelector('.money')
const fromFlagImg = document.querySelector('#from-flag') 
const toFlagImg = document.querySelector('#to-flag')
...
const pull = async () => {
  ...
  money.textContent = `Money: ${data.result} ${toCurrency}`
}
